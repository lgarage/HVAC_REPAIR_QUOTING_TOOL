...
_None. Most recent delivery (Apr 2026) — the purple **Preview** button in each Recent Quotes Database row now auto-opens the full PDF preview (identical to the main **Preview Quote** flow), so a dispatcher can re-preview any past quote in one click. No open blockers._
