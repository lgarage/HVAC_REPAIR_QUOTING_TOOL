...
_None. Most recent delivery (Apr 2026) — quote persistence hardened with a non-destructive seeder plus **Export / Import Backup** controls above the Recent Quotes Database, guaranteeing a dispatcher's historical quotes are preserved across refreshes, profile changes, and device migrations. No open blockers._
